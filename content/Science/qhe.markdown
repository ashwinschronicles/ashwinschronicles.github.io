...
[@RevModPhys.89.040502]

Theoretical aspects [@QHELecture; @Tong]
========================================
...
thickness, t, Length L, and width W, as shown in Fig
[\[fig:hall\]](#fig:hall){reference-type="ref" reference="fig:hall"}.
...
![Schematic diagram of the Hall effect measurement setup
[\[fig:hall\]]{#fig:hall
label="fig:hall"}](img/Hall_Effect_Measurement_Setup_for_Electrons "fig:")[@wiki-halleffect_2019]
...
V_{H} & = & v_{x}B_{z}w\end{aligned}$$ [\[Vheqn\]]{#Vheqn label="Vheqn"}
...
effects. on doing so [\[Vheqn\]](#Vheqn){reference-type="ref"
reference="Vheqn"} gets modified as $$\begin{aligned}
...
### Experimental verification of hall effect.[@shar]
...
**Part-1:** The value of magnetic field corresponding to particular
...
![image](img/hall_data_table){width="12cm"}

![Magnetic field vs Current ](img/hall_data_graph){width="10cm"}

**Part-2:** The values of Hall Voltages are measured for different
geometrical combinations.The data obtained is as follows -

![image](img/hall_data_table2){width="12cm"}

Corresponding graphs are plotted here.

\subfloat{\centering{}\includegraphics[width=7cm]{img/hall_data_graph2}}
\subfloat{\centering{}\includegraphics[width=7cm]{img/hall_data_graph3}}
\subfloat{\centering{}\includegraphics[width=7cm]{img/hall_data_graph4}}
\subfloat{\centering{}\includegraphics[width=7cm]{img/hall_data_graph5}}
From all these graphs, the average value of slope is **0.03218
$\unitfrac{mV}{Gauss}$** . We have sample current equal to 10mA and
...
The observed resistivity is shown in
Fig[\[fig:RhvsB\]](#fig:RhvsB){reference-type="ref"
reference="fig:RhvsB"}.

![Hall resistance and longitudinal resistivity data as a function of the
magnetic field for a GaAs/AlGaAs hetero-structures at 1.5 K
.[\[fig:RhvsB\]]{#fig:RhvsB label="fig:RhvsB"}
](img/HallPvsB "fig:"){width="7cm"}[@QHELecture]
...
[\[quantisedHallValue\]]{#quantisedHallValue label="quantisedHallValue"}
...
two along y axis similar to the arrangement in Fig
[\[fig:hall\]](#fig:hall){reference-type="ref" reference="fig:hall"}.
...
[\[quantisedHallValue\]](#quantisedHallValue){reference-type="ref"
reference="quantisedHallValue"}

### Landau Levels[@wiki-landau]

In presence of magnetic field, electrons follow circular trajectories
called cyclotron orbits.

-   The charged particles can only occupy orbits with discrete energy
...
B_{z}x\\
0
\end{pmatrix}.}$$ where $x\ifmmode\begingroup\def\b@ld{bold}
  \text{\ifx\math@version\b@ld\bfseries\fi\^}\endgroup\else\^\fi$ is the
x component of the position operator. In this gauge, the Hamiltonian is
...
$\ifmmode\begingroup\def\b@ld{bold}
  \text{\ifx\math@version\b@ld\bfseries\fi\textcrh}\endgroup\else\textcrh\fi k_{y}$.

The Hamiltonian can also be written more simply by noting that the
cyclotron frequency is $\omega_{c}=\nicefrac{qB}{mc}$, giving
...
shifted in coordinate space by $x_{0}=\ifmmode\begingroup\def\b@ld{bold}
  \text{\ifx\math@version\b@ld\bfseries\fi\textcrh}\endgroup\else\textcrh\fi k_{y}/m\omega c$.
...
With this argument we can conclude that the state of the electron can
uniquely determined by two by two quantum numbers, n and $k_{y}$. Now
let us focus on the degeneracy of Landau level.

Degeneracy of Landau levels[@Tong][@wiki-landau] {#degeneracy-of-landau-levels .unnumbered .unnumbered}
------------------------------------------------
...
$kT\ll\ifmmode\begingroup\def\b@ld{bold}
  \text{\ifx\math@version\b@ld\bfseries\fi\textcrh}\endgroup\else\textcrh\fi\omega c$,
...
### Edge modes[@RevModPhys.89.040502]
...
![Edge states in a sample](img/edge)
